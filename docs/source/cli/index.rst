...
For example, to set up the required directory structure in /var/www/myapp, and populate it with the files required for module *mymodule*, run with the ``-i`` switch such as:

.. code:: bash

    $ cd /var/www
    $ luxon -i mymodule myapp
