...
# NOTICE:
# Ultra-Fast Router found and developed in Falcon.
# MODIFIED FOR for Luxon Framework Project.
# Original Project: https://github.com/falconry/falcon
...
from luxon.core.router import converters
...
class CompiledRouter(object):
    ...
    def add_route(self, uri_template, method_map, resource, tag=None):
